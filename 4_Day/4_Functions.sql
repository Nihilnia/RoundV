...
-- avg()
-- SELECT avg(Price) as 'Average Price' from gloria_db.products
...
-- SELECT Name, Price FROM gloria_db.products ORDER BY Price DESC limit 3

Select max(Price) as 'Maximum Price' FROM gloria_db.products