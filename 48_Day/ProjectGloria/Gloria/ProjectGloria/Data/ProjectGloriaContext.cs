...
namespace Gloria.ProjectGloria.Data
{
    public partial class ProjectGloriaContext : DbContext
    {
        public ProjectGloriaContext()
        {
        }

        public ProjectGloriaContext(DbContextOptions<ProjectGloriaContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;port=3306;database=projectgloria;user=root;password=1234", x => x.ServerVersion("8.0.26-mysql"));
            }
        }
