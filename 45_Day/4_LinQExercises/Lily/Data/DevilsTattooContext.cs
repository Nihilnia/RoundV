...
{
    public partial class DevilsTattooContext : DbContext
    {
        public DevilsTattooContext()
        {
        }

        public DevilsTattooContext(DbContextOptions<DevilsTattooContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("server=localhost;port=3306;database=DevilsTattoo;user=root;password=1234", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.26-mysql"));
            }
        }
