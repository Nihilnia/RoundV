...
$(function(){
  ...
  if(getCookie('theme') && (getCookie('theme') != 'default') ){
    $('head').append('<link href="/banzhow/css/themes/'+getCookie('theme')+'.css" rel="stylesheet" id="theme-stylesheet">');
  }
  ...
  $(".theme-colour").on('click', function(event) {
    ...
    if(theme != 'default'){
      $('head').append('<link href="/banzhow/css/themes/'+theme+'.css" rel="stylesheet" id="theme-stylesheet">');
    }
