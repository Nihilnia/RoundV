...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.EmployeePrivilege", b =>
                {
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.InventoryTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.InventoryTransactionType", b =>
                {
                    b.Property<sbyte>("Id")
                        .HasColumnType("tinyint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.OrderDetailsStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.OrdersStatus", b =>
                {
                    b.Property<sbyte>("Id")
                        .HasColumnType("tinyint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.OrdersTaxStatus", b =>
                {
                    b.Property<sbyte>("Id")
                        .HasColumnType("tinyint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Privilege", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.SalesReport", b =>
                {
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Shipper", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.String", b =>
                {
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.EmployeePrivilege", b =>
                {
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Employee", "Employee")
                        .WithMany("EmployeePrivileges")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("fk_employee_privileges_employees1")
                        .IsRequired();

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Privilege", "Privilege")
                        .WithMany("EmployeePrivileges")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.InventoryTransaction", b =>
                {
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Order", "CustomerOrder")
                        .WithMany("InventoryTransactions")
                        .HasForeignKey("CustomerOrderId")
                        .HasConstraintName("fk_inventory_transactions_orders1");

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Product", "Product")
                        .WithMany("InventoryTransactions")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("fk_inventory_transactions_products1")
                        .IsRequired();

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrder", "PurchaseOrder")
                        .WithMany("InventoryTransactions")
                        .HasForeignKey("PurchaseOrderId")
                        .HasConstraintName("fk_inventory_transactions_purchase_orders1");

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.InventoryTransactionType", "TransactionTypeNavigation")
                        .WithMany("InventoryTransactions")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Invoice", b =>
                {
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Order", "Order")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.Order", b =>
                {
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Customer", "Customer")
                        .WithMany("Orders")
                    ...
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Shipper", "Shipper")
                        .WithMany("Orders")
                        .HasForeignKey("ShipperId")
                        .HasConstraintName("fk_orders_shippers1");

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.OrdersStatus", "Status")
                        .WithMany("Orders")
                        .HasForeignKey("StatusId")
                        .HasConstraintName("fk_orders_orders_status1");

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.OrdersTaxStatus", "TaxStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.OrderDetail", b =>
                {
                    ...
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.OrderDetailsStatus", "Status")
                        .WithMany("OrderDetails")
                        .HasForeignKey("StatusId")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrder", b =>
                {
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Employee", "CreatedByNavigation")
                        .WithMany("PurchaseOrders")
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("fk_purchase_orders_employees1");

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrderStatus", "Status")
                        .WithMany("PurchaseOrders")
                        .HasForeignKey("StatusId")
                        .HasConstraintName("fk_purchase_orders_purchase_order_status1");

                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.Supplier", "Supplier")
                        .WithMany("PurchaseOrders")
            ...
            modelBuilder.Entity("_3_ScaffoldingDatabase.Data.Lily.PurchaseOrderDetail", b =>
                {
                    b.HasOne("_3_ScaffoldingDatabase.Data.Lily.InventoryTransaction", "Inventory")
